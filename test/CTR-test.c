...
int main()
{
    ...
    unsigned char key1[17] = {0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c, '\0'};
    ...
    //AES128 CRT 암호화
    CTR(AES128_Encrypt, IV1_enc, key1, 16, len, pad_plainText, output);
    ...
    CTR(AES128_Decrypt, IV1_dec, key1, 16, len, output, output2);
